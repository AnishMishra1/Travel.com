    ...
    <>
      ...
      <div className="flex flex-col bg-white md:py-[2rem] md:px-[4rem] px-[0.7rem] items-center gap-3">
        <div className="h-auto w-full p-4 text-start rounded-md flex flex-col gap-3 md:p-[5rem]">
          <p>
            Welcome to kwalitytravels. This privacy statement outlines the terms and conditions governing your use of
            our website. Please carefully review this privacy policy as it pertains to all aspects of your travel
            experience.
          </p>
          <p>
            At kwalitytravels, we prioritize building a strong relationship between our users and the accommodations
            they require. This Privacy Statement aims to inform you about the personal information we collect from you
            and how we intend to use it. Your cooperation and openness to our processes are crucial for us to operate
          ...
          <p>
            kwalitytravels is linked to third-party integrators. Users should exercise caution when interacting with
            these links. We advise against sharing personal information on external sites unless they are verified as
          ...
          <p>
            kwalitytravels complies with the CCPA Privacy Policy Act, giving consumers control over their personal
